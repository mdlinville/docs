...
- improve handling of docker image job names and tags. <!-- by @gtarpenning in https://github.com/wandb/wandb/pull/5718 -->
- support kaniko builds on AKS. <!-- by @bcsherma in https://github.com/wandb/wandb/pull/5706 -->
- allow kaniko builds to run in other namespaces. <!-- by @bcsherma in https://github.com/wandb/wandb/pull/5637 -->
- support access key for Azure references. <!-- by @szymon-piechowicz-wandb in https://github.com/wandb/wandb/pull/5729 -->
- add information to failed run queue items, support warnings for run queue items. <!-- by @KyleGoyette in https://github.com/wandb/wandb/pull/5612 -->
- allow direct configuration of registry uri for all registries. <!-- by @bcsherma in https://github.com/wandb/wandb/pull/5760 -->
- enhance download URL fetching process with batch and retry logic. <!-- by @szymon-piechowicz-wandb in https://github.com/wandb/wandb/pull/5692 -->
- add flag to skip missing S3 references in `Artifact.download`. <!-- by @moredatarequired in https://github.com/wandb/wandb/pull/5778 -->
- implement job requeueing when pod disconnects. <!-- by @TimH98 in https://github.com/wandb/wandb/pull/5770 -->
- add setting to disable setproctitle. <!-- by @raubitsj in https://github.com/wandb/wandb/pull/5805 -->

### :hammer: Fixes

- handle uri schemes in LogicalPath. <!-- by @dmitryduev in https://github.com/wandb/wandb/pull/5670 -->
- update object storage to include reference and prevent id reuse. <!-- by @szymon-piechowicz-wandb in https://github.com/wandb/wandb/pull/5722 -->
- update click package version requirements. <!-- by @gtarpenning in https://github.com/wandb/wandb/pull/5738 -->
- improve lazy import to be thread-safe. <!-- by @szymon-piechowicz-wandb in https://github.com/wandb/wandb/pull/5727 -->
- change typo in kaniko image name. <!-- by @bcsherma in https://github.com/wandb/wandb/pull/5743 -->
- correct date parsing in SageMaker configuration. <!-- by @rymc in https://github.com/wandb/wandb/pull/5759 -->
- make docker build non interactive to prevent region based questions. <!-- by @KyleGoyette in https://github.com/wandb/wandb/pull/5736 -->
- update "cuda" base image path to "accelerator" base image path. <!-- by @KyleGoyette in https://github.com/wandb/wandb/pull/5737 -->
- replace artifact name with placeholder to skip validation. <!-- by @szymon-piechowicz-wandb in https://github.com/wandb/wandb/pull/5724 -->
- prevent jobs with large outputs from hanging on local-container. <!-- by @KyleGoyette in https://github.com/wandb/wandb/pull/5774 -->
- Ensure resume does not push sensitive info. <!-- by @KyleGoyette in https://github.com/wandb/wandb/pull/5807 -->
- fix handling of references when downloading. <!-- by @szymon-piechowicz-wandb in https://github.com/wandb/wandb/pull/5808 -->
- correct launch sweep author to personal username. <!-- by @gtarpenning in https://github.com/wandb/wandb/pull/5806 -->
- change artifact methods and attributes to private. <!-- by @szymon-piechowicz-wandb in https://github.com/wandb/wandb/pull/5790 -->

### :books: Docs

- update docs. <!-- by @szymon-piechowicz-wandb in https://github.com/wandb/wandb/pull/5701 -->
- fix comment about total retry time. <!-- by @szymon-piechowicz-wandb in https://github.com/wandb/wandb/pull/5751 -->
...
- set job source in settings. <!-- by @TimH98 in https://github.com/wandb/wandb/pull/5442 -->
- launch sweeps controlled by wandb run. <!-- by @gtarpenning in https://github.com/wandb/wandb/pull/5456 -->
- add autolog for Cohere python SDK. <!-- by @dmitryduev in https://github.com/wandb/wandb/pull/5474 -->
- support launching custom k8s objects. <!-- by @bcsherma in https://github.com/wandb/wandb/pull/5486 -->
- conserve memory when hashing files. <!-- by @moredatarequired in https://github.com/wandb/wandb/pull/5513 -->
- add new_draft method to modify and log saved artifacts as new version. <!-- by @szymon-piechowicz-wandb in https://github.com/wandb/wandb/pull/5524 -->
- don't install frozen reqs if there is a reqs file. <!-- by @bcsherma in https://github.com/wandb/wandb/pull/5548 -->
- don't remove temp files from artifacts cache by default. <!-- by @moredatarequired in https://github.com/wandb/wandb/pull/5596 -->
- add source_entity and update sequenceName handling. <!-- by @szymon-piechowicz-wandb in https://github.com/wandb/wandb/pull/5546 -->
- add 'remove' to Artifacts API. <!-- by @moredatarequired in https://github.com/wandb/wandb/pull/5370 -->
- optuna scheduler for sweeps on launch. <!-- by @gtarpenning in https://github.com/wandb/wandb/pull/4900 -->
- support notebook job creation. <!-- by @KyleGoyette in https://github.com/wandb/wandb/pull/5462 -->
- enable launch macros for all runners. <!-- by @bcsherma in https://github.com/wandb/wandb/pull/5624 -->
- add autologging for supported huggingface pipelines. <!-- by @ash0ts in https://github.com/wandb/wandb/pull/5579 -->
- add usage metrics and table logging to OpenAI autologger. <!-- by @parambharat in https://github.com/wandb/wandb/pull/5521 -->
- add support for monitoring AMD GPU system metrics. <!-- by @dmitryduev in https://github.com/wandb/wandb/pull/5449 -->
- capture absolute GPU memory allocation. <!-- by @dmitryduev in https://github.com/wandb/wandb/pull/5643 -->

### :hammer: Fixes

- ensure wandb can be used in AWS lambda. <!-- by @dmitryduev in https://github.com/wandb/wandb/pull/5083 -->
- permit `LogicalPath` to strip trailing slashes. <!-- by @moredatarequired in https://github.com/wandb/wandb/pull/5473 -->
- exercise caution when creating ~/.config/wandb/settings file. <!-- by @dmitryduev in https://github.com/wandb/wandb/pull/5478 -->
- update custom chart query handling and add alternate constructor for table-based charts. <!-- by @andrewtruong in https://github.com/wandb/wandb/pull/4852 -->
- add s3 multipart uploading for artifact files. <!-- by @estellazx in https://github.com/wandb/wandb/pull/5377 -->
- handle incompatible artifact name strings. <!-- by @andrewtruong in https://github.com/wandb/wandb/pull/5416 -->
- docker runner always pull for image sourced jobs. <!-- by @bcsherma in https://github.com/wandb/wandb/pull/5531 -->
- improve error handling for package installation. <!-- by @TimH98 in https://github.com/wandb/wandb/pull/5509 -->
- custom k8s objects respect command/args overrides. <!-- by @bcsherma in https://github.com/wandb/wandb/pull/5538 -->
- remove entity, project from valid properties and adjust name handling. <!-- by @szymon-piechowicz-wandb in https://github.com/wandb/wandb/pull/5533 -->
- use env var for launch agent base url. <!-- by @KyleGoyette in https://github.com/wandb/wandb/pull/5482 -->
- write to the cache defensively (catch OSError). <!-- by @moredatarequired in https://github.com/wandb/wandb/pull/5597 -->
- handle exception in finish_thread_id and fail run queue items. <!-- by @KyleGoyette in https://github.com/wandb/wandb/pull/5610 -->
- add pull secrets for pre made images when registry is specified. <!-- by @bcsherma in https://github.com/wandb/wandb/pull/5602 -->
- read kaniko pod sa name from env var. <!-- by @bcsherma in https://github.com/wandb/wandb/pull/5619 -->
- misc gcp fixes. <!-- by @bcsherma in https://github.com/wandb/wandb/pull/5626 -->
- support local environment and registry declaration. <!-- by @KyleGoyette in https://github.com/wandb/wandb/pull/5630 -->
- support ssh git urls and submodules in agent. <!-- by @KyleGoyette in https://github.com/wandb/wandb/pull/5635 -->
- update git repo handling for failure cases and rename to gitlib. <!-- by @kptkin in https://github.com/wandb/wandb/pull/5437 -->
- unify offline and online mode during init and fix multiprocess attach. <!-- by @kptkin in https://github.com/wandb/wandb/pull/5296 -->
- prevent errors by checking for `wandb.run` in Gym integration. <!-- by @ash0ts in https://github.com/wandb/wandb/pull/5649 -->
- fix wandb tfevent sync issue. <!-- by @eohomegrownapps in https://github.com/wandb/wandb/pull/5261 -->
...
- allow SDK to work if SA token can't be read. <!-- by @wandb-zacharyblasczyk in https://github.com/wandb/wandb/pull/5472 -->
- clean up the k8s token discovery logic in util.py::image_id_from_k8s. <!-- by @dmitryduev in https://github.com/wandb/wandb/pull/5518 -->
- Update `WandbTracer` to work with new langchain version. <!-- by @parambharat in https://github.com/wandb/wandb/pull/5558 -->
- update summary for changed keys only. <!-- by @dmitryduev in https://github.com/wandb/wandb/pull/5562 -->
...
- fix error message in langchain wandb_tracer version check. <!-- by @dmitryduev in https://github.com/wandb/wandb/pull/5490 -->
...
- implement new Kubernetes runner config schema. <!-- by @TimH98 in https://github.com/wandb/wandb/pull/5231 -->
- allow platform override for docker builder. <!-- by @TimH98 in https://github.com/wandb/wandb/pull/5330 -->
- get full name of artifact for easier artifact retrieval. <!-- by @estellazx in https://github.com/wandb/wandb/pull/5314 -->
- make default root for artifacts download configurable. <!-- by @moredatarequired in https://github.com/wandb/wandb/pull/5366 -->
- add Azure storage handler in SDK. <!-- by @szymon-piechowicz-wandb in https://github.com/wandb/wandb/pull/5317 -->
- add method to convert wandb.Table to pandas.DataFrame. <!-- by @brunnelu in https://github.com/wandb/wandb/pull/5301 -->
- sweeps on launch command args passed as params. <!-- by @gtarpenning in https://github.com/wandb/wandb/pull/5315 -->

### :hammer: Fixes

- don't assume keys in args and config refer to the same thing. <!-- by @szymon-piechowicz-wandb in https://github.com/wandb/wandb/pull/5183 -->
- make ElasticContainerRegistry environment handle "ImageNotFoundException" gracefully. <!-- by @bcsherma in https://github.com/wandb/wandb/pull/5159 -->
- disable kaniko builder retry. <!-- by @TimH98 in https://github.com/wandb/wandb/pull/5318 -->
- refine error message for auth error. <!-- by @kptkin in https://github.com/wandb/wandb/pull/5341 -->
- kubernetes runner does not respect override args. <!-- by @KyleGoyette in https://github.com/wandb/wandb/pull/5303 -->
- allow attr-dicts as sweeps configs. <!-- by @moredatarequired in https://github.com/wandb/wandb/pull/5268 -->
- checksum the read-only staging copy instead of the original file. <!-- by @moredatarequired in https://github.com/wandb/wandb/pull/5346 -->
- skip getting run info if run completes successfully or is from a different entity. <!-- by @TimH98 in https://github.com/wandb/wandb/pull/5379 -->
- default to project "uncategorized" instead of "None" when fetching artifacts. <!-- by @szymon-piechowicz-wandb in https://github.com/wandb/wandb/pull/5375 -->
- add enabled check to gym VideoRecorder. <!-- by @younik in https://github.com/wandb/wandb/pull/5230 -->
- fix handling of default project and entity. <!-- by @dmitryduev in https://github.com/wandb/wandb/pull/5395 -->
- update import_hook.py with latest changes in the wrapt repository. <!-- by @kptkin in https://github.com/wandb/wandb/pull/5321 -->
- fix support for local urls in k8s launch agent. <!-- by @KyleGoyette in https://github.com/wandb/wandb/pull/5413 -->
- improve notebook environment detection and testing. <!-- by @dmitryduev in https://github.com/wandb/wandb/pull/4982 -->
- implement recursive isinstance check utility for the Settings object. <!-- by @dmitryduev in https://github.com/wandb/wandb/pull/5436 -->
- correctly parse edge cases in OpenMetrics filter definitions in System Monitor. <!-- by @dmitryduev in https://github.com/wandb/wandb/pull/5329 -->
- update debug logs to include SDK's version. <!-- by @kptkin in https://github.com/wandb/wandb/pull/5344 -->
- filter AWS Trainium metrics by local rank if executed with torchrun. <!-- by @dmitryduev in https://github.com/wandb/wandb/pull/5142 -->
- inform users about WandbTracer incompatibility with LangChain > 0.0.153. <!-- by @hwchase17 in https://github.com/wandb/wandb/pull/5453 -->

### :books: Docs

- update docstrings of the Keras callbacks. <!-- by @ayulockin in https://github.com/wandb/wandb/pull/5198 -->
...
- add support for LangChain media type. <!-- by @tssweeney in https://github.com/wandb/wandb/pull/5288 -->
...
- add function signature wrapper to the patched openai methods. <!-- by @parambharat in https://github.com/wandb/wandb/pull/5369 -->
