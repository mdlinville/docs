...
## Prerequisites
1. Review the [requirements and limitations](/models/launc#more-details) for LLM Evaluation Jobs.
...
<Frame>
![Example hosted model evaluation job](/images/models/llm-evaluation-jobs/hosted-model-job-example.pn)
</Frame>
