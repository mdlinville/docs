...
markdown_files_with_tags = {
    'input1.md': ['team', 'organization'],
    'input2.md': ['team', 'entity'],
    'input3.md': ['team', 'information']
}


markdown_files_with_tags = {
'../docs/guides/technical-faq/general.md': [''],
'../docs/guides/technical-faq/admin.md' :[''],
'../docs/guides/technical-faq/metrics-and-performance.md' :[''],
'../docs/guides/technical-faq/setup.md' :  [''],
'../docs/guides/technical-faq/troubleshooting.md': [''],
